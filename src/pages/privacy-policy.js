				...
				<div className="container">
					<div className="row">
						<div className={`col-lg-12`}>
							...
							<p>
								Margrit Spear's website is committed to safeguarding and preserving the privacy of our
								visitors.
							</p>
							<p>
							...
							<p>
								In running and maintaining our website, Margrit Spear's website may collect and process
